...
<body>
    <div class="container mt-5">
        ...
        <form action="{{ route('kajians.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section text-center">
                <h2 class="section-title">Tambah Data Kajian</h2>
                <p class="section-subtitle">Sesuaikan dan perhatikan isian format kajian</p>
            </div>

            <div class="form-section">
                <h2 class="section-title">Informasi Umum Kajian</h2>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="judul">Judul Kajian</label>
                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Masukkan Judul Kajian">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="sektoral" name="sektoral" >
            ...
            <div class="form-section">
                <h2 class="section-title">Bagian Isi Kajian</h2>
                <div class="form-group">
                    <label for="latar">Latar Belakang</label>
                    <textarea class="form-control" id="latar" name="latar" rows="3"
                        placeholder="Masukkan latar belakang secara rinci..."></textarea>
                </div>
                <div class="form-group">
                    <label for="metodologi">Metodologi</label>
                    <textarea class="form-control" id="metodologi" name="metodologi" rows="3"
                        placeholder="Masukkan isi metodologi secara rinci..."></textarea>
                </div>
                <div class="form-group">
                    <label for="pelaksana">Pelaksana</label>
                    <textarea class="form-control" id="pelaksana" name="pelaksana" rows="3"
                        placeholder="Masukkan isi pelaksana secara rinci..."></textarea>
                </div>
                <div class="form-group">
                    <label for="data">Data Ringkas</label>
                    <textarea class="form-control" id="data" name="data" rows="3"
                        placeholder="Masukkan data ringkas secara rinci..."></textarea>
                </div>
                <div class="form-group">
                    <label for="unit_id">Unit ID</label>
                    <textarea class="form-control" id="unit_id" name="unit_id" rows="3"
                        placeholder="Masukkan data ringkas secara rinci..."></textarea>
                </div>
                <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            $('#lokasikajian, #sektorKajian').select2({
                placeholder: "Pilih",
                allowClear: true
            });
        });
