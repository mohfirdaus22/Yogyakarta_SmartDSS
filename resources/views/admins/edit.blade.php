...
<body>
    <div class="container">
        ...
        <div class="form-container">
            <h1 class="mb-4 text-center section-title">Update Admin</h1>
            <form action="{{ route('admins.update', $admin->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="nik">NIK:</label>
                    <input type="text" class="form-control" name="nik" id="nik" value="{{ $admin->nik }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="sektor" id="sektor" value="{{ $admin->sektor }}" required>
                </div>
